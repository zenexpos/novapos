...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ...
        className={cn(
            ...
            'border border-input bg-[var(--glass-bg)] backdrop-blur-sm',
...
>(({ className, ...props }, ref) => (
    <SelectPrimitive.Label
        ref={ref}
        className={cn('py-1.5 pl-8 pr-2 text-xs font-semibold tracking-tight text-muted-foreground/40', className)}
        {...props}
    />
));
...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Item
        ref={ref}
        className={cn(
            'relative flex w-full cursor-default select-none items-center rounded-lg py-2 pl-8 pr-3 text-sm font-medium',
            'outline-none',
