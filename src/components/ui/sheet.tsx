...
>(({ side = "right", className, children, ...props }, ref) => {
  ...
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute right-4 top-4 rounded-full p-2 bg-muted text-foreground hover:bg-secondary hover:text-white transition-all opacity-100 z-50 shadow-sm">
        <X className="h-4 w-4" />
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("text-lg font-black leading-none tracking-tight uppercase text-foreground", className)}
    {...props}
  />
))
