...
export function DeleteExpenseDialog({ isOpen, onOpenChange, onConfirm, isLoading, name }: Props) {
    return (
            ...
            <AlertDialogContent className="glass-elevated rounded-2xl">
                <AlertDialogHeader>
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <AlertDialogTitle className="text-base font-black">Supprimer la dépense</AlertDialogTitle>
                    </div>
