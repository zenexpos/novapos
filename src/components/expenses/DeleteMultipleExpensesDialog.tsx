...
export function DeleteMultipleExpensesDialog({ isOpen, onOpenChange, onConfirm, isLoading, count }: Props) {
    return (
            ...
            <AlertDialogContent className="glass-elevated rounded-2xl">
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="text-sm text-muted-foreground/70 leading-relaxed">
                        ...
                        {' '}Cette action supprimera toutes les dépenses sélectionnées.
